...
<title>Login Admin | Sistem Informasi Penilaian Akademik Kurikulum 2013 Berbasis Web Pada SDN Tangkil 03 Wlingi - Blitar</title>
...
<body style="background-image: url('../images/back.jpg');">
	<div class="login-kotak" style="background: #fff;">
        ...
        <form action="cek-login.php" name="login" method="post" enctype="multipart/form-data">
            <div class="label"><h2>LOGIN ADMIN</h2></div>
            	<?php
                      ...
                      if (!empty($_GET['pesan']) && $_GET['pesan'] == 'tidak-aktif') {
                           echo '<div class="label-eror">
                                Username Anda Sudah Di Nonaktifkan
                                </div>';
                          }    
				?>
            <div class="input-login"><input type="text" placeholder="Username" name="username" required autofocus style="vertical-align:middle" class="in-text"></div>
            ...
            <a href="../" class="button b-reset" style="width:190px"><span>Batal </span></a>
            </div>
        </form>    
        </div>
