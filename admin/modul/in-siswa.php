...
<meta name="description" content="Input Siswa | Sistem Informasi Penilaian Akademik Kurikulum 2013 Berbasis Web Pada SDN Tangkil 03 Wlingi - Blitar">
<meta name="author" content="Malik">
<title>Input Siswa | Sistem Informasi Penilaian Akademik Kurikulum 2013 Berbasis Web Pada SDN Tangkil 03 Wlingi - Blitar</title>
...
<div class="container" style="margin-top:70px;">
  <div class="row">
    <div class="col-md-12">
    <?php
                      if (!empty($_GET['pesan']) && $_GET['pesan'] == 'gagal-input-siswa') {
                           echo '<div class="label-eror">
                                NIS Sudah Terdaftar
                                </div>';
                          }
					   if (!empty($_GET['pesan']) && $_GET['pesan'] == 'sukses-input-siswa') {
                ...
                <div class="panel panel-success">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">NIS</label>
							<div class="col-sm-9">
								<input type="text" name="nis" maxlength="20" class="form-control" required>
							</div>
                    </div>
                    ...
                    <div class="form-group">
						<label class="col-sm-2 control-label">Nama Siswa</label>
							<div class="col-sm-9">
								<input type="text" name="nama_siswa" maxlength="100" class="form-control" required>
							</div>
                    </div>
  ...
  ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" name="telp_siswa" maxlength="13" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <button type="submit" name="in-siswa" class="button b-login" style="vertical-align:middle"><span>Input Data </span></button>
                    </div>
                </div>
