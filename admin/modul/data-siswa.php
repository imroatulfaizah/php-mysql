    ...
    <?php
                ...
                <div class="panel panel-primary">
  					<div class="panel-heading">Data Siswa</div>
                        ...
                        <a href="in-siswa.php" class="btn btn-warning waves-effect">Tambah Siswa</a>
                         </div>
                         <div class="col-md-5">
        ...
        <thead>
          <tr>
              ...
              if(isset($_GET['cari'])){
                ...
                $hsl = $_GET['pencarian'];
                $no = 1;
                $sql = "SELECT * FROM siswa,kelas WHERE siswa.id_kelas=kelas.id_kelas AND (siswa.nis like '%$hsl%' or siswa.nama_siswa like '%$hsl%' or kelas.nama_kelas like '%$hsl%') ORDER BY siswa.id_kelas ASC";
          ...
          <tbody>
            ...
            <?php if(isset($_GET['page']) && $_GET['page'] != ''){
              ...
              $page = $_GET['page'];
                ...
                $namabulan = array("","Januari","Pebruari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");
                    $href        = "data-siswa.php";  
                    $sql = 'SELECT * FROM siswa,kelas WHERE siswa.id_kelas=kelas.id_kelas ORDER BY siswa.id_kelas ASC';
