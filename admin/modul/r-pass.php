    ...
    <?php
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label" for="name">Usermane</label>
                  <div class="col-md-10">
                  <input id="name" name="username" value="<?php echo $_SESSION['username']?>" type="text" placeholder="Username" class="form-control" readonly>
                  </div>
                </div>
