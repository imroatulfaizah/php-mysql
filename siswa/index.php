...
<title>Login Siswa | Sistem Informasi Penilaian Akademik Kurikulum 2013 Berbasis Web Pada SDN Tangkil 03 Wlingi - Blitar</title>
...
<body style="background-image: url('../images/back.jpg');">
	<div class="login-kotak"  style="background: #fff;">
        ...
        <form action="cek-login.php" name="login" method="post" enctype="multipart/form-data">
            <div class="label"><h2>LOGIN SISWA</h2></div>
            	<?php
                      if (!empty($_GET['pesan']) && $_GET['pesan'] == 'log-gagal') {
                           echo '<div class="label-eror">
                                Nomor Induk / Password Anda Salah
                                </div>';
                          }
				...
				?>
            <div class="input-login"><input type="text" placeholder="NIS" name="nis" required autofocus style="vertical-align:middle" class="in-text"></div>
