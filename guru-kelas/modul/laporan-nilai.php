...
<div class="container" style="margin-top:70px; width:95%;">
            ...
            <div class="panel-heading">Laporan Nilai</div>
                ...
                <button type="submit" name="cari" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-search"></span> Proses</button>
                 ...
                 <div class="alert alert-danger">
                    <b>Keterangan :</b> Pilih Semester & Tahun Ajaran terlebih dahulu untuk melihat laporan nilai.
                 </div> 
 ...
 <?php 
              ...
              if($cari == 0){
				echo "<tr>
            <td colspan='24' style='border: none;'><center><b>Data Tidak Di Temukan / Anda Belum Memberikan Nilai</a></center><br></td>
                        </tr>";
              }else{
