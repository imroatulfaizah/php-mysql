        ...
        <div class="modal-body">
        	<form action="proses.php" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
     			...
     			<input type="text" name="nama_siswa"  class="form-control" value="<?php echo $r['nama_siswa']; ?> " disabled/>
                </div>

                <div class="form-group" >
                	<label class="control-label">Tanggal Lahir</label> <br><br>
                    <div class="col-sm-2">
     				<select name="tgl" size="1" id="tgl" class="form-control" disabled>
                <?php
             for ($i=1;$i<=31;$i++)
             {
                if($tanggal==$i) {
          ...
          ?>
              ...
              <div class="col-sm-4">
             <select name="bln" size="1" id="bln" class="form-control" disabled>
                <?php
          ...
          ?>
              ...
              <div class="col-sm-3">
              <select name="thn" size="1" id="thn" class="form-control" disabled>
                <?php
          ...
          ?>
				...
				<div class="form-group">
     			...
     			<textarea name="alamat" rows="5" cols="10px" class="form-control" disabled><?php echo $r['alamat'];?></textarea>
                </div>
                
                <div class="form-group">
                	<label class="control-label">Telepon</label>
     			<input type="text" name="telp_siswa"  class="form-control" value="<?php echo $r['telp_siswa']; ?> " onKeyPress="return goodchars(event,'0123456789',this)" disabled />
                </div>
                ...
                <div class="form-group">
     			...
     			<select name="thn1" class="form-control" disabled>
