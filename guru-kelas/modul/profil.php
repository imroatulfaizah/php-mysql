...
<body>
  ...
  <div class="row">
 <?php 
$query = mysqli_query($koneksi,"SELECT * FROM guru_kelas WHERE nip = '$_SESSION[nip]'");
 ...
 ?>
    <div class="col-md-3">
            ...
            if (!empty($_GET['pesan']) && $_GET['pesan'] == 'gagal-input-gambar-salah-guru') {
                        ...
                        <input type="hidden" name="nip" value="<?php echo $data['nip']?>"><!-- Id Foto -->
                  ...
                  <button type="submit" name="edit-foto" class="btn btn-danger form-control">Proses Rubah</button>
           
                        </div>
                        <div class="panel-footer"><p style="background:#B97628;width:100%;padding:10px;text-align:center;color:#fff;font-size:20px;border-radius:5px;"><?php echo $_SESSION['nama_guru']?></p></div>
                </div>
                </form>
    </div>  
                        ...
                        ?>
                         ...
                         <input type="hidden" name="nip" value="<?php echo $data['nip'] ?>">
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="inputEmail3" placeholder="NIP" name="nip1" value="<?php echo $data['nip']?>" disabled>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="inputPassword3" placeholder="Nama Guru" name="nama_guru" value="<?php echo $data['nama_guru']?>">
                                </div> 
                              </div>
          ...
          ?>
                ...
                <option value="Ateis" <?php if($data['agama'] == 'Ateis'){echo 'selected';}?> >Ateis</option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="inputPassword3" placeholder="Telepon Guru" name="telp_guru" value="<?php echo $data['telp_guru']?>">
                                </div> 
                              </div>
                		...
                		<?php } ?>
                              ...
                              <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                  <button type="submit" class="btn btn-primary" name="edit-profil">Edit Profil</button>
                                </div>
                              </div>
                          </form>
